  ...
  path '/api/v1/studios/{studio_id}/reservations' do
    get 'Retrieve reservations' do
      ...
      response '200', 'Reservations retrieved successfully' do
        ...
        let(:reservation1) { Reservation.create!(reservation_date: '01-11-2023', location: 'Mid-land', studio_id: studio.id, user_id: user.id) }
        let(:reservation2) { Reservation.create!(reservation_date: '01-12-2023', location: 'Alaska', studio_id: studio.id, user_id: user.id) }
    ...
    post 'Create a reservation' do
      ...
      response '201', 'Reservation created successfully' do
        ...
        let(:reservation) { Reservation.create!(reservation_date: '01-11-2023', location: 'Mid-land', studio_id: studio.id, user_id: user.id) }
